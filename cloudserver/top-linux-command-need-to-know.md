# Top Linux Command Need to Know for Developers & DevOps
...
- FILES & NAVIGATING
  ...
  - cd path/dir => change to dir in parent directory 
  ...
  - m-rf / => launch some neu clear bombs targeting your system 
...
- COMPRESSING
  ...
  - tar xf file.tar => un-tar into current directory 
...
- NETWORKING
  ...
  - dig domain => get NS for domain 
  - dig -x host => reserve lookup host 
  - wget file => download file
  - wget -c file => continue stopped download 
  - wget -r url => recursively download files from uri 
